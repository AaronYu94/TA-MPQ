...
\subsection{Frozen Policies and Evaluation Protocol}
...
\subsection{MATH-500 and Token-Wall Sensitivity}
...
\subsection{Completion-Token Usage Across the Suite}
...
\subsection{Interpretation, Failure Cases, and Remaining Ablations}
